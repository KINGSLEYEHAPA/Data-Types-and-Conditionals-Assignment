...
if(room== "ballroom"&&suspect == "Mr kalehoff"&& solved == false ){
...
else if(room== "gallery"&& suspect == "Ms. Van Cleve"&& solved ==false ){
...
else if(room== "dining room"&&suspect == "Mr. Parkes"&& solved == false ){
   
  solved=true;

  console.log(`${suspect}  did it in the ${room} with the ${weapon}.`);
} 
else if(room== "billiards room" &&suspect =="Mrs Sparr"&&  solved ==false ){
  solved=true;
...
if(solved){
  console.log("The murder mystery has been solved.");
}
...
console.log("Ypur account is Empty.")
...
if(shirtWidth>= 17&&shirtWidth<19&&shirtLength<=28.50&&shirtLength>25&&shirtSleeve<=8.20&&shirtSleeve>7.5){

console.log(" size S (small)");

}
else if(shirtWidth>= 20&&shirtWidth<20.9&&shirtLength<=29&&shirtLength>28.6&&shirtSleeve<=8.38&&shirtSleeve>8.25){

  console.log(" size M (Medium)");
}
else if (shirtWidth>= 22&&shirtWidth<22.5&&shirtLength<=30.50&&shirtLength>=30&&shirtSleeve<=8.63&&shirtSleeve>8.50){
 console.log(" size L (Large)");

}

else if (shirtWidth>= 24&&shirtWidth<25&&shirtLength<=32&&shirtLength>=31&&shirtSleeve<=8.88&&shirtSleeve>8.70){
   console.log(" size XL (Extra Large)");
}
else if (shirtWidth>= 26&&shirtWidth<26.80&&shirtLength<=33&&shirtLength>=32.50&&shirtSleeve<=9.80&&shirtSleeve>=9.63){

  console.log(" size 2XL (Very Extra Large)");
}
else if (shirtWidth>= 28&&shirtWidth<28.90&&shirtLength<=34.50&&shirtLength>=34&&shirtSleeve<=10.50&&shirtSleeve>=10.13){

console.log(" size 3XL (Super Large)");
